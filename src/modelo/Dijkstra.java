...
public class Dijkstra {
    //varialvel para armazenar o passo a passo do algoritmo
    ...
    public List<Vertice> encontrarMenorCaminhoDijkstra(Grafo grafo, Vertice v1,Vertice v2) {
        ...
        while (!this.naoVisitados.isEmpty()) {
            ...
            // Toma-se sempre o vertice com menor distancia, que é o primeiro
            // da
            // lista
            atual = this.naoVisitados.get(0);
            //System.out.println("Pegou esse vertice:  " + atual);
            saida += "Pegou esse vertice:  " + atual + "\n";
            /*
            ...
            for (int i = 0; i < atual.getArestas().size(); i++) {
                ...
                saida += "Olhando o vizinho de " + atual + ": " + vizinho + "\n";
                if (!vizinho.verificarVisita()) {
                    ...
                    if (vizinho.getDistancia() > (atual.getDistancia() + atual
                        ...
                        /*
						 * Se o vizinho e o vertice procurado, e foi feita uma
            ...
            saida += "Nao foram visitados ainda:" + naoVisitados + "\n";
